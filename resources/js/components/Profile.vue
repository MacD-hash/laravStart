        ...
        <div class="row justify-content-center">
            <div class="col-md-12 mt-3">
               <div class="card card-widget widget-user">
                <div class="widget-user-header text-white" style="background: url('./img/profile/user-cover.jpg');">
                    <h3 class="widget-user-username text-right">Muhammad</h3>
                  ...
                  <div class="tab-pane active" id="settings">
                    <form class="form-horizontal">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input v-model="form.name" type="text" id="inputName" placeholder="Name"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea v-model="form.bio" type="text"id="bio" placeholder="Short bio for user (Optional)"
